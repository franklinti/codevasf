...
<body>
	...
	Existe ${fn:length(listaLicitacao)} licitacao!
		...
		<c:forEach var="licitacao" items="${listaLicitacao}">
			<button class="accordion">Licitacoes - <c:out value="${licitacao.item}"/> <c:out value="${at}" /></button>
            <div class="panel">
			...
			<tr>
				...
				<tr>
				    ...
				    <td>
				     <c:url  value="Licitacao?action=Excluirframe&id=${licitacao.id}" var="urlexcluir"/>
				     <a type="submit" href="${urlexcluir}"><button class="btn"><i class="fa fa-trash"></i></button></a>
				     <c:url  value="Licitacao?action=Editarframe&id=${licitacao.id}" var="urleditar"/>
				     <a type="submit" href="${urleditar}"><button class="btn"><i class="fa fa-pencil"></i></button></a>
				   </td>
				</tr>
		</table>
		</div>
